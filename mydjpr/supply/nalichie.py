...
def nalichie_rozn(file_path, add_message):
    ...
    add_message('Готово за ' + str(time() - t) + '.Наличие Розница ' + str(f'{srznach:.3f}'))
...
def nalichie_comp(file_path, add_message):
    ...
    add_message('Готово за ' + str(time() - t) + '. Наличие компания ' + str(f'{nalichie:.3f}') + ' ' +  str(l1) + '/' +  str(l2))
...
def nalichie_comp_RF(file_path, add_message):
    ...
    add_message('Готово за ' + str(time() - t) + '. Наличие компания по поставщикам РФ ' +  str(f'{nalichie:.3f}') + ' ' +  str(l1) + '/' +  str(l2))